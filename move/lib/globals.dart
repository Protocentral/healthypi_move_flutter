...
class hPi4Global {
  ...
  static const List<int> LogCount = [0x30];
  static const List<int> LogIndex = [0x31];
  static const List<int> FetchLogFile = [0x32];
  static const List<int> LogDelete = [0x33];
  static const List<int> LogWipeAll = [0x34];
